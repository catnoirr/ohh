  ...
  return (
    <div className="my-6 w-full sm:px-6 px-3">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="text-white text-sm border border-[#A3A3A3] bg-[#F2F0F53D] px-2 py-1 rounded-md" onClick={() => router.push("/campaigns")}>
          View All
        </button>
      </div>

      {/* Grid Layout for Campaigns */}
      <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 justify-center items-center">
        {isLoading ? (
