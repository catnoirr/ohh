...
const Campaign = () => {
  ...
  const ooh1 = id.slice(14, 17);
  const ooh2 = id.slice(17, 20);
  console.log(ooh2);
  ...
  const fetchUser = async () => {
    if (ooh1 !== "ooh" && ooh2 !== "ooh") {
      toast.error("Scan from OOH Point website to open this link");
      router.push("/");
      return;
    }
