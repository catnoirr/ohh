...
const InValidCoupons = () => {
    const [totalInValidCoupons, setTotalValidCoupons] = useState(0);
    ...
    useEffect(() => {
      ...
      if (currentUser) {
        ...
        return (
            ...
            <img src="/totalsaving.png" alt="expence-tag" className="w-6 h-4" />
            </div>
              <div className="text-white">
                <p className="text-xs font-medium">Expired </p>
                <p className="text-lg font-semibold">{totalInValidCoupons}</p>
              </div>
