...
const CampaignPage = () => {
  ...
  return (
    ...
    <div className="bg-gray-100 min-h-screen p-2 max-w-md flex flex-col  ">
        <div>
      ...
      <div className=" mx-auto shadow-lg rounded-lg  flex gap-10  flex-col justify-center items-center  ">
        <div>
        ...
        {(!activeTab || activeTab === 'overview') && (
          <div className="border-2 shadow-lg ">
            ...
            {/* Opening Hours */}
            <div className="flex gap-20 flex-col bg-white">
              <div className="p-6">
